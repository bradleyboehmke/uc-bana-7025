...
As you read through this chapter, we encourage you to follow along using the [companion notebook](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/14_eda.ipynb) in Google Colab (or other editor of choice).

👉 Open the [EDA Notebook in Colab](https://colab.research.google.com/github/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/14_eda.ipynb).
:::
...
The workflow in this chapter — question → structure → distributions → segmentation → story — is exactly the workflow to apply at the start of your semester project. This section bridges the two: it connects the EDA framework to your project and gives you a structured exercise to begin putting it into practice.
...
Your semester project will require you to conduct an EDA similar to the one in this chapter — but on a question and analytical angle of your own choosing. This exercise is about developing and sharpening that question.
