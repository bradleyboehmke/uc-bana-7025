...
Open the [planes.csv](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/data/planes.csv) file in Excel, Google Sheets, or your preferred spreadsheet tool. Then try to answer this question:
...
As you read through this chapter, we encourage you to follow along using the [companion notebook](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/08_subsetting.ipynb) in Google Colab (or other editor of choice). This interactive notebook lets you run code examples covered in the chapter—and experiment with your own ideas.

👉 Open the [Subsetting Notebook in Colab](https://colab.research.google.com/github/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/08_subsetting.ipynb).
:::
...
Now that you can import, inspect, and subset a DataFrame, it's time to apply those skills to the **Complete Journey** dataset — the retail grocery data you'll use throughout the semester project.
