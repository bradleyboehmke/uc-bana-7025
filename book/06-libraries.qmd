...
As you read through this chapter, we encourage you to follow along using the [companion notebook](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/05_libraries.ipynb) in Google Colab (or other editor of choice). This interactive notebook lets you run code examples covered in the chapter—and experiment with your own ideas.

👉 Open the [Libraries Notebook in Colab](https://colab.research.google.com/github/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/05_libraries.ipynb).
:::
...
2. Once installed, copy and run the following code in a Jupyter notebook:
   ...
   text = bokeh.models.Label(x=0, y=0, text='BANA 7025', text_align='center')
   p.add_layout(text)
...
3. After executing the code:
   ...
   * What part of the code controls the label “BANA 7025”?
...
3. Add a markdown cell answering the following:
   ...
   * What part of the code adds the label “BANA 7025”?
:::
