...
Before we dive into the code, let’s simulate your first task on the job. Check out [this](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/data/ames_raw.csv) dataset on residential property sales in Ames, Iowa ([source](http://jse.amstat.org/v19n3/decock.pdf)).

1. Download the ames_raw.csv file from this URL:
https://github.com/bradleyboehmke/uc-bana-7025/blob/main/data/ames_raw.csv
...
As you read through this chapter, we encourage you to follow along using the [companion notebook](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/06_importing_data.ipynb) in Google Colab (or other editor of choice). This interactive notebook lets you run code examples covered in the chapter—and experiment with your own ideas.

👉 Open the [Importing Data Notebook in Colab](https://colab.research.google.com/github/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/06_importing_data.ipynb).
:::
...
In the example below, we use `read_csv()` to load a [dataset listing some information on aircraft](https://raw.githubusercontent.com/bradleyboehmke/uc-bana-7025/refs/heads/main/data/planes.csv). 
...
Download the [`ames_raw.csv` dataset](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/data/ames_raw.csv) and save the file in a folder structure like this:
...
In this example, we’ll import a mock dataset of grocery store products stored in a file called `products.xlsx` (download [here](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/data/products.xlsx)).
