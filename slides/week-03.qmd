...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bradleyboehmke/uc-bana-7025/blob/main/notebooks/tuesday-your-turn/week-03-lecture.ipynb)
:::
...
**Option 1: Load directly from a URL**
```{python}
ames = pd.read_csv('https://raw.githubusercontent.com/bradleyboehmke/uc-bana-7025/main/data/ames_raw.csv')
```
