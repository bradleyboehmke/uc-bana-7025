...
- What is a variable?
- What is a assignment and how do we do it?
...
2. Assign your age to a second variable
3. Using an f-string and print statement - *"My name is _____ and I am __ years old."*
:::
...
[Project notebook](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/example_notebook.ipynb) · [Homework notebook](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/example_homework_notebook.ipynb)
:::


## 📋 Exercise: What Makes These Notebooks Work? {.smaller}

**Both examples:** [Project notebook](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/example_notebook.ipynb) · [Homework notebook](https://github.com/bradleyboehmke/uc-bana-7025/blob/main/notebooks/examples/example_homework_notebook.ipynb)
...
**The test:** could a stakeholder, a technical reviewer, and future-you each get what they need — without you in the room to explain it?
:::
